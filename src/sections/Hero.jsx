...
function Hero() {
  return (
    <motion.section
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-5 md:px-10 grid md:grid-cols-2 gap-14 items-center">
        ...
        <div>
          ...
          >
            <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/5 border border-white/10">
              ...
              <span className="text-zinc-300">120+ Landings</span>
            </div>
            <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/5 border border-white/10">
              <TrendingUp size={16} className="text-zinc-300" />
              <span className="text-zinc-300">+156% conversión</span>
            </div>
            <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/5 border border-white/10">
              <Zap size={16} className="text-zinc-300" />
              <span className="text-zinc-300">48-72 horas</span>
            </div>
          </motion.div>
